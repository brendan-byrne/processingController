...
void setup() {
  //MaxMaxMax,57600 is more fast? looks like faster.
  Serial.begin(57600);                                           //Initiate serial communication for debugging/connecting with Processing
...
void loop() {
  ...
  //MaxMaxMax
  // DEBUGGING + OUTPUT ZONE                                    This can all be removed
  // --------------------------
  //  Serial.print("Dials    :  ");
  //  for (int x=0; x<8; x++) {
